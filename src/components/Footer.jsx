    ...
    <footer className="w-full footer papas h-screen overflow-hidden relative z-2">
      <div className="bg beta w-full h-full will-change-transform  bg-[#4a4a4a] overflow-hidden">
        ...
        <div className="ovelay w-full h-full absolute top-0 left-0 p-40 max-[599px]:p-4 flex items-center justify-center gap-40 max-[599px]:flex-col-reverse max-[599px]:gap-6">
          <div className="left w-1/2 max-[599px]:w-full h-full px-20 max-[599px]:px-6 pt-20 max-[599px]:pt-6">
            <ul className="text-[3vw] max-[599px]:text-[6vw] links font-bold text-[#dedede] leading-none flex max-[599px]:justify-center  flex-col gap-10 max-[599px]:gap-6">
          ...
          <div className="right w-1/2 max-[599px]:w-full h-full text-[#dedede] pt-20 max-[599px]:pt-0 max-[599px]:pt-40 max-[599px]:px-4">
            <div className="head">
              <div className="logo flex items-center gap-2">
                ...
                <h1 className="text-[3vw] max-[599px]:text-[9vw] font-bold fText1">Senova AI</h1>
              </div>
              <p className="my-10 text-[2vw] max-[599px]:text-[6vw] font-medium leading-tight fText2">
